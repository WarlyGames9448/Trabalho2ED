...
class OrderBook {
  ...
  private:
    ...
    // Ordens inseridas primeiro (menor id) estará mais próximo de H (para manter ordenação)
    ...
    // A escolha de uma lista circular é para maior velocidade de inserção no "fim" da lista caso não haja correspondencia
    // sem precisar percorrer uma outra lista caso usássemos duas listas separadas.
